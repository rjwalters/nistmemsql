...
pub(super) fn if_func(args: &[vibesql_types::SqlValue]) -> Result<vibesql_types::SqlValue, ExecutorError> {
    if args.len() != 3 {
    ...
    match condition {
        ...
        vibesql_types::SqlValue::Boolean(false) | vibesql_types::SqlValue::Null => Ok(args[2].clone()),
