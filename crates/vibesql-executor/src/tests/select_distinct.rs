...
fn test_distinct_with_multiple_columns() {
    ...
    db.insert_row(
        ...
        vibesql_storage::Row::new(vec![
            ...
            vibesql_types::SqlValue::Varchar("pending".to_string()),
        ]),
    )
    .unwrap();
    db.insert_row(
        ...
        vibesql_storage::Row::new(vec![
            vibesql_types::SqlValue::Integer(2),
            vibesql_types::SqlValue::Integer(100),
            vibesql_types::SqlValue::Varchar("shipped".to_string()),
        ]),
    )
    .unwrap();
    db.insert_row(
    ...
    let stmt = vibesql_ast::SelectStmt {
        ...
        from: Some(vibesql_ast::FromClause::Table { name: "orders".to_string(), alias: None }),
        where_clause: None,
        group_by: None,
        having: None,
        order_by: None,
...
fn test_distinct_with_null_values() {
    ...
    db.insert_row(
        ...
        vibesql_storage::Row::new(vec![
            vibesql_types::SqlValue::Integer(1),
            vibesql_types::SqlValue::Varchar("Item A".to_string()),
        ]),
    )
    .unwrap();
    db.insert_row(
...
fn test_distinct_false_preserves_duplicates() {
    ...
    db.insert_row(
        "products",
        vibesql_storage::Row::new(vec![vibesql_types::SqlValue::Varchar("Books".to_string())]),
    )
    .unwrap();
...
fn test_distinct_with_where_clause() {
    ...
    db.insert_row(
        ...
        vibesql_storage::Row::new(vec![
            vibesql_types::SqlValue::Integer(1),
            vibesql_types::SqlValue::Varchar("admin".to_string()),
        ]),
    )
    .unwrap();
    db.insert_row(
        ...
        vibesql_storage::Row::new(vec![
            vibesql_types::SqlValue::Integer(2),
            vibesql_types::SqlValue::Varchar("user".to_string()),
        ]),
    )
    .unwrap();
    db.insert_row(
...
fn test_distinct_with_order_by() {
    ...
    assert_eq!(result.len(), 2);
    assert_eq!(result[0].values[0], vibesql_types::SqlValue::Varchar("Books".to_string()));
    assert_eq!(result[1].values[0], vibesql_types::SqlValue::Varchar("Electronics".to_string()));
}
