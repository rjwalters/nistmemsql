...
mod in_subquery {
    ...
    fn test_delete_where_in_subquery() {
        ...
        let subquery = Box::new(vibesql_ast::SelectStmt {
            ...
            from: Some(vibesql_ast::FromClause::Table { name: "inactive_depts".to_string(), alias: None }),
            where_clause: None,
            group_by: None,
            having: None,
            order_by: None,
...
mod scalar_subquery {
    ...
    fn test_delete_where_subquery_returns_null() {
        ...
        let subquery = Box::new(vibesql_ast::SelectStmt {
            ...
            from: Some(vibesql_ast::FromClause::Table { name: "config".to_string(), alias: None }),
            where_clause: None,
            group_by: None,
            having: None,
            order_by: None,
...
mod empty_subquery {
    ...
    fn test_delete_where_subquery_empty_result() {
        ...
        let subquery = Box::new(vibesql_ast::SelectStmt {
            ...
            from: Some(vibesql_ast::FromClause::Table { name: "old_depts".to_string(), alias: None }),
            where_clause: None,
            group_by: None,
            having: None,
            order_by: None,
