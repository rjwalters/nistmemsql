...
fn test_st_length_linestring() {
    let expr = Expression::Function {
        ...
        args: vec![
            Expression::Function {
                name: "ST_GEOMFROMTEXT".to_string(),
                args: vec![Expression::Literal(SqlValue::Varchar("LINESTRING(0 0, 3 0, 3 4)".to_string()))],
                character_unit: None,
            },
        ],
        character_unit: None,
...
fn test_st_area_polygon() {
    let expr = Expression::Function {
        ...
        args: vec![
            Expression::Function {
                name: "ST_GEOMFROMTEXT".to_string(),
                args: vec![Expression::Literal(SqlValue::Varchar("POLYGON((0 0, 10 0, 10 10, 0 10, 0 0))".to_string()))],
                character_unit: None,
            },
        ],
        character_unit: None,
        ...
        args: vec![
            Expression::Function {
                ...
                args: vec![
                    Expression::Function {
                        name: "ST_GEOMFROMTEXT".to_string(),
                        args: vec![Expression::Literal(SqlValue::Varchar("LINESTRING(0 0, 1 1, 0 1)".to_string()))],
                        character_unit: None,
                    },
                ],
                character_unit: None,
