...
fn test_examples_load_northwind_database() {
    ...
    assert!(
        statement_count + error_count > 0,
        "Expected to process some statements"
    );
}
...
// ========== Web-Demo Examples Validation Tests ==========
