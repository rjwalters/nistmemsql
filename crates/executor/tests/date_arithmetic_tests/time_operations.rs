...
fn test_date_add_hours_across_midnight() {
    ...
    let expr = ast::Expression::Function {
        ...
        args: vec![
            ast::Expression::Literal(types::SqlValue::Timestamp("2024-01-15 23:00:00".parse().unwrap())),
    ...
    assert_eq!(result, types::SqlValue::Timestamp("2024-01-16 01:00:00".parse().unwrap()));
}
...
fn test_date_add_minutes_overflow() {
    ...
    let expr = ast::Expression::Function {
        name: "DATE_ADD".to_string(),
        args: vec![
            ast::Expression::Literal(types::SqlValue::Timestamp("2024-01-15 11:30:00".parse().unwrap())),
    ...
    let result = evaluator.eval(&expr, &row).unwrap();
    assert_eq!(result, types::SqlValue::Timestamp("2024-01-15 13:00:00".parse().unwrap()));
}
...
fn test_date_add_seconds_overflow() {
    ...
    let expr = ast::Expression::Function {
        name: "DATE_ADD".to_string(),
        args: vec![
            ast::Expression::Literal(types::SqlValue::Timestamp("2024-01-15 10:30:30".parse().unwrap())),
    ...
    let result = evaluator.eval(&expr, &row).unwrap();
    assert_eq!(result, types::SqlValue::Timestamp("2024-01-15 11:31:31".parse().unwrap()));
}
...
fn test_date_sub_hours_across_midnight() {
    ...
    let expr = ast::Expression::Function {
        ...
        args: vec![
            ast::Expression::Literal(types::SqlValue::Timestamp("2024-01-16 01:00:00".parse().unwrap())),
            ast::Expression::Literal(types::SqlValue::Integer(2)),
            ast::Expression::Literal(types::SqlValue::Varchar("HOUR".to_string())),
        ],
        character_unit: None,
    ...
    let result = evaluator.eval(&expr, &row).unwrap();
    assert_eq!(result, types::SqlValue::Timestamp("2024-01-15 23:00:00".parse().unwrap()));
}
