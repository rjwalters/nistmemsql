//! Tests for substring extraction functions
//!
//! This module covers:
//! - SUBSTRING - Extract substring with start position and optional length
...
//! - NULL handling
//! - Empty strings
//! - Boundary conditions (negative/zero lengths, positions beyond string length)
