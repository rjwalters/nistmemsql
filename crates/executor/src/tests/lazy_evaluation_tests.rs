...
fn test_coalesce_lazy_evaluation_short_circuits() {
    ...
    let expr = ast::Expression::Function {
        ...
        args: vec![
            ast::Expression::Literal(SqlValue::Integer(10)),
...
fn test_coalesce_evaluates_all_when_all_null() {
    ...
    let expr = ast::Expression::Function {
        name: "COALESCE".to_string(),
        args: vec![
            ast::Expression::Literal(SqlValue::Null),
            ast::Expression::Literal(SqlValue::Null),
            ast::Expression::Literal(SqlValue::Integer(42)),
        ],
        character_unit: None,
    };
...
fn test_nullif_returns_first_when_not_equal() {
    ...
    let expr = ast::Expression::Function {
        ...
        args: vec![
            ast::Expression::Literal(SqlValue::Integer(42)),
            ast::Expression::Literal(SqlValue::Integer(43)),
        ],
        character_unit: None,
    };
...
fn test_coalesce_with_strings() {
    ...
    let expr = ast::Expression::Function {
        ...
        args: vec![
            ast::Expression::Literal(SqlValue::Null),
            ast::Expression::Literal(SqlValue::Varchar("hello".to_string())),
            ast::Expression::Literal(SqlValue::Varchar("world".to_string())),
        ],
        character_unit: None,
    };
