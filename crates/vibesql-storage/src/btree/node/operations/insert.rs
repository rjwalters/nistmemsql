...
//!
//! This module contains all insertion logic including split propagation and root creation.

use crate::page::PageId;
use crate::StorageError;

use super::super::structure::{InternalNode, Key, RowId};
...
impl BTreeIndex {
    ...
    pub(super) fn create_new_root(
        ...
        self.set_root_and_height(new_root_page_id, self.height() + 1)?;
