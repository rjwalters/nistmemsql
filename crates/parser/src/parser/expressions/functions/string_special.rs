...
impl Parser {
    ...
    pub(super) fn parse_position_function(&mut self) -> Result<ast::Expression, ParseError> {
    ...
    pub(super) fn parse_trim_function(&mut self) -> Result<ast::Expression, ParseError> {
