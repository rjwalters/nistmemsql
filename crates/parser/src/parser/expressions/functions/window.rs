...
impl Parser {
    ...
    pub(super) fn parse_window_spec(&mut self) -> Result<ast::WindowSpec, ParseError> {
    ...
    pub(super) fn parse_frame_clause(&mut self) -> Result<ast::WindowFrame, ParseError> {
    ...
    pub(super) fn parse_frame_bound(&mut self) -> Result<ast::FrameBound, ParseError> {
        match self.peek() {
